...
#if 0
     // Function jumper, jump to a specific address when reaching this point
     // Declare a function pointer named jump_addr that points to a function which
     //returns void and takes no arguments
     void (*jump_addr) (void);

     // SRAM address - but no instructions at this address
     jump_addr =  (void*) 0x20000009;

     // will jump to above address
     jump_addr();
#endif
